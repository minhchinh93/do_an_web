...
/*!********************************************!*\
  !*** ./resources/assets/assets/js/demo.js ***!
  \********************************************/
...
demo = {
  ...
  initDocChartist: function initDocChartist() {
    var _optionsSales;
  ...
  initChartist: function initChartist() {
    ...
    var optionsSales = (_optionsSales2 = {
      ...
      divisor: 3
    })), _defineProperty(_optionsSales2, "showLine", false), _defineProperty(_optionsSales2, "showPoint", false), _optionsSales2);
    var responsiveSales = [['screen and (max-width: 640px)', {
      axisX: {
        labelInterpolationFnc: function labelInterpolationFnc(value) {
          return value[0];
